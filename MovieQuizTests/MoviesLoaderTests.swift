...
class MoviesLoaderTests: XCTestCase {
    ...
    func testSuccesLoading() throws {
        ...
        //When т.к ф-я загрузки фильмов асонхронная нужно ожидание
        ...
        loader.loadMovies { result in
            ...
            case .success(let movies):
                //проверим что пришло например два фильма в тестовых данных их всего два
                XCTAssertEqual(movies.items.count, 2)
                expectation.fulfill()
            case .failure(_):
                //мы не ожидаем что пришла ошибка если оня появится надо провалить тест
